...
import com.kiendtph37589.duan1_nhom6_new.Adapter.KichCo_Adapter;
...
public class ChiTietSPActivity extends AppCompatActivity {
    ...
    int so = 0;
    String kichco = "";
    private KichCo_Adapter adapterKichco;
...
//        mua = findViewById(R.id.btn_mua);
    ...
    private void themGio() {
        ...
        db.collection("gioHang").document(maGio).
                set(new gioHangDTO(maGio, user.getUid(), sanPhamDTO.getMaSp(),kickco.getText().toString(), Long.parseLong(soluong.getText().toString() )))
