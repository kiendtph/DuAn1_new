...
//                                });
        ...
        ll_doiMk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AlertDialog.Builder builder = new AlertDialog.Builder(ThongTinTKActivity.this);
                View view1 = getLayoutInflater().inflate(R.layout.dialog_doimatkhau_nguoidung, null, false);
                builder.setView(view1);
                builder.setCancelable(false);
                Dialog dialog = builder.create();
                dialog.show();

                EditText ed_mkCu = view1.findViewById(R.id.edt_mkCu_nguoiDung);
                EditText ed_mkMoi = view1.findViewById(R.id.edt_mkMoi_nguoiDung);
                EditText ed_re_mk = view1.findViewById(R.id.edt_re_mkMoi_nguoiDung);
                Button btn_huy = view1.findViewById(R.id.btn_huy_ng);
                Button btn_luu = view1.findViewById(R.id.btn_luu_ng);
